...
export default function Sidebar() {
  return (
    <div className="w-64 bg-zinc-950 border-r border-zinc-800 text-zinc-300 flex flex-col h-screen overflow-hidden">
      ...
      <div className="p-4 border-t border-zinc-800 text-sm text-zinc-500 mt-auto shrink-0">
